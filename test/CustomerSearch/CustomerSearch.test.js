...
import { CustomerSearch } from "../../src/components/CustomerSearch/CustomerSearch";
import { render } from "react-dom";

jest.mock(
  "../../src/components/CustomerSearch/SearchButtons",
  () => ({
...
describe("CustomerSearch", () => {
  ...
  it("pass customer to the renderCustomerActions render props", async () => {
    global.fetch.mockResolvedValue(
      fetchResponseOk(oneCustomer)
    );
  ...
  it("render SearchButtons with props", async () => {
    global.fetch.mockResolvedValue(
